...
private:
    ...
    template<typename T, typename U, std::size_t N,std::size_t I,  typename...Arg_Ts>
    ...
    static constexpr auto member_function_jump_table = Jump_Table_Array<Tagged_Union, func_wrapper, sizeof...(Ts), 0, Arg_Ts...>();

    template<typename var_wrapper, typename...Arg_Ts> // TODO: implement. Will require changes to Jump_Table_Array
    static constexpr auto member_variable_jump_table = Jump_Table_Array<Tagged_Union, var_wrapper, sizeof...(Ts), 0, Arg_Ts...>();
...
public:
    ...
    template<typename T> // TODO: require T be in Ts...
