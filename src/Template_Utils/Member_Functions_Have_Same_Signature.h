...
namespace detail {
    ...
    template<class T, class U, typename return_t, typename...arg_ts>
    struct member_functions_have_same_signature_helper<return_t(T::*)(arg_ts...) const, return_t(U::*)(
            arg_ts...) const> {
        static constexpr bool value = true;
    };
    ...
    constexpr bool member_functions_have_same_signature_v = detail::member_functions_have_same_signature_helper<decltype(V), decltype(W)>::value;
...
namespace detail {
    ...
    constexpr bool all_member_functions_have_same_signature_helper_func() {
        if constexpr(sizeof...(vals) == 0) {
            ...
            return member_functions_have_same_signature_v<val1, val2> &&
                   all_member_functions_have_same_signature_helper_func<val2, vals...>();
        }
    }
...
template<auto...vals>
constexpr bool all_member_functions_have_same_signature_v = detail::all_member_functions_have_same_signature_helper_func<vals...>();

template<typename T, typename V>
static constexpr bool member_variables_have_same_type_v = detail::member_variables_have_same_type<std::remove_const_t<T>, std::remove_const_t<V>>::value;